...
from running_mission_cycle_gui import RunningFlightMissionCycle
...
def run_mission_cycle(code_location):
    ...
    while correct_com == False:
        ...
        correct_com = True # remove before running properly!!!!
    ...
    # missing_activities = []
    # for activity in arduino_activities:
    #     if activity not in PC_activities:
    ...
    app = RunningFlightMissionCycle(PC_activities)
